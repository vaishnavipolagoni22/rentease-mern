...
const RenterHome = () => {
  ...
  const handleBook = async (e) => {
    e.preventDefault();
    try {
      await API.post('/bookings', { propertyId: bookingModal._id, ...bookForm });
            ...
            <div className="row g-2 mb-4">
              <div className="col-md-5">
                <input className="form-control bg-dark text-white border-secondary"
                  placeholder="Search by Address" value={search}
            ...
            <div className="row g-4">
              {properties.map(p => (
                <div key={p._id} className="col-md-4">
                  <div className="card h-100" style={{ backgroundColor: '#2a2a3e', color: 'white', border: 'none' }}>
                    {p.images && p.images[0] ? (
                    ...
                    <div className="card-body">
                      ...
                      <p className="small">Availability:{' '}
                      ...
                      {p.availability ? (
                        ...
                        <button className="btn btn-secondary btn-sm w-100" disabled>Not Available</button>
                      )}
                    </div>
                  </div>
                </div>
            ...
            <div className="modal-content bg-dark text-white">
              ...
              <div className="modal-body">
                ...
                <form onSubmit={handleBook}>
                  <input className="form-control bg-dark text-white border-secondary mb-3"
                    placeholder="Your Full Name" value={bookForm.tenantName}
                    onChange={e => setBookForm({ ...bookForm, tenantName: e.target.value })} required />
                  <input className="form-control bg-dark text-white border-secondary mb-3"
                    placeholder="Your Phone Number" value={bookForm.tenantPhone}
                    onChange={e => setBookForm({ ...bookForm, tenantPhone: e.target.value })} required />
